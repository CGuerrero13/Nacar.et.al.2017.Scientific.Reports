function [out] = BWAOV2_SAP(X,alpha)
...
fprintf('---------------------------------------------------------------------------\n');
fprintf('LNat           %11.3f%10i%15.3f%14.3f%9.4f\n\n',SSA,v1,MSA,F1,P1);
fprintf('Error(LNat)    %11.3f%10i%15.3f\n\n',SSEA,v2,MSEA);
fprintf('LagSound           %11.3f%10i%15.3f%14.3f%9.4f\n\n',SSB,v3,MSB,F2,P2);
fprintf('GroupxLagSound       %11.3f%10i%15.3f%14.3f%9.4f\n\n',SSAB,v4,MSAB,F3,P3);
fprintf('Error(GroupxLagSound)%11.3f%10i%15.3f\n\n',SSEAB,v5,MSEAB);
